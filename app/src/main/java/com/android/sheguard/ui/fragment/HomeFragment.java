...
import com.android.sheguard.ui.activity.Events;
...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //binding.feed.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_aboutFragment));
    ...
    private void initializeDrawerItems() {
        ((NavigationView) requireActivity().findViewById(R.id.navView)).setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_profile) {
                ...
                Intent i=new Intent(getContext(), userEvents.class);
                startActivity(i);
            }
